				...
				<td style="width: 110px; padding: 0; vertical-align: top;" title="">
					<div style="width: 100%;">
						...
						<div style="padding: 15px 0 0 0;">
							...
							<div class="nishka">
								<input style="margin: 4px 1px 4px 0;" class="radio" id="<?=$this->get_field_id('taxonomy'); ?>" title="Displays a navigation menu created via WP Admin Panel:  <span style='font-weigt: bold'>Appearance > Menus</span>.<br><span class='green'>Portfolio Categories</span>, <span class='green'>Portfolio Items</span>, <span class='green'>Portfolio Filters</span>, <span class='green'>Slider Categories</span> and/or <span class='green'>Slider Items</span> can be selected via this option - see <span style='font-weight: bold; color: #dc143c;'>GUIDE & TIPS</span><span style='font-weight: bold;'> > Cloud Content Tips</span> section, <span style='font-weight: bold;'>item 5</span>.<br><span class='green'>Weight Mode</span> is not applicable to this option. Combine with the <span class='green'>Menu Name</span> option on the right."
...
//									echo '<option id="auli_55"'; if($authors_limit==''){echo ' selected';}; echo ' value="">all</option>';
			...
			<tr>
				<td colspan="2" style="border-bottom: 1px solid #aaa;">
					<div style="clear: both; padding: 0 0 5px 0;" title="My Shape Function takes 4 standard arguments:<br><span class='green'>n</span> - number of tags to position,<br><span class='green'>xr</span> - X radius,<br><span class='green'>yr</span> - Y radius and<br><span class='green'>zr</span> - Z radius.<br>The function must return an array containing <span class='green'>n</span> entries, each entry being an array of X,Y,Z coordinates, e.g. for n == 2, the array returned could be [[1,2,3], [3,1,5]].<br><strong>N.B.</strong> X is left-right, Y is top-bottom & Z is front-back.<br>Example (Sphere):<br><br>function my_shape(n, xr, yr, zr){<br>&nbsp;var i, y, r, p=[], inc=Math.PI*(3-Math.sqrt(5)), off=2/n;<br>&nbsp;for(i = 0; i &lt; n; ++i) {<br>&nbsp; y = i*off-1+(off/2);<br>&nbsp; r = Math.sqrt(1-y*y);<br>&nbsp; p.push([Math.cos(i*inc)*r*xr, y*yr, Math.sin(i*inc)*r*zr]);<br>&nbsp;}<br>&nbsp;return p;<br>}">
						<b>N.B.</b> For <span style='font-weight: bold;'>Portfolio</span> & <span style='font-weight: bold;'>Slider</span> types of content see section <span style='font-weight: bold; color: #dc143c;'>GUIDE & TIPS</span><span style='font-weight: bold;'> > Cloud Content Tips</span>, item <span style='font-weight: bold;'>5</span>.
					</div>
