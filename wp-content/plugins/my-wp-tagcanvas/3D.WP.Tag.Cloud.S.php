...
//	$message = "In order to make your old <b>" . $plugin_data['Name'] . "</b> widget instances compatible with the new version just go to <b><a href='widgets.php'>Widgets</a></b>, open each one of them and save it without any change.";
	$message = "Starting from this version of <b>" . $plugin_data['Name'] . "</b> you can put in the cloud <b>Portfolio Categories</b>, <b>Portfolio Items</b>, <b>Portfolio Filters</b>, <b>Slider Categories</b> and <b>Slider Items</b>. For instructions on how to do it go to <b>Cloud Content Tips</b>, item <b>5</b>, under <b>GUIDE & TIPS</b> section of the widget.";
	$display_info = false;
