...
class FG_Joomla_to_WordPress_Premium {
	...
	public function __construct() {
		...
		$this->parent_plugin_name = 'fgj2wp';
		$this->version = '2.5.2';
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_filter( 'fgj2wp_get_sections_sql', $plugin_joomla10, 'get_sections_sql', 10, 2 );
		$this->loader->add_filter( 'fgj2wp_get_categories_sql', $plugin_joomla10, 'get_categories_sql', 10, 2 );
		$this->loader->add_filter( 'fgj2wp_get_posts_sql', $plugin_joomla10, 'get_posts_sql', 10, 7 );
		...
		$this->loader->add_filter( 'fgj2wp_pre_process_post', $plugin_joomla25, 'process_featured_image', 10, 1 );
		...
		$this->loader->add_action( 'fgj2wp_import_notices', $plugin_menus, 'display_menus_count', 50 );
		...
		$this->loader->add_filter( 'fgj2wp_import_notices', $plugin_modules, 'display_modules_count', 50 );
		...
		$this->loader->add_action( 'fgj2wp_import_notices', $plugin_users, 'display_users_count' );
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'parse_request', $plugin_redirect, 'process_url' );
