...
<div class="sf-wrapper">
	...
	<div class="sf-filter">
		<?php do_action( 'sf-before-form', $field ); ?>
		<?php if( defined( 'ICL_LANGUAGE_CODE' )  ): ?>
			<input type="hidden" name="wpml" value="<?php echo ICL_LANGUAGE_CODE ?>" />
		<?php endif; ?>
		...
		<?php foreach( $field['fields'] as $key => $element ):
			...
			if( isset( $_POST[ $key ] ) ){
				if( is_array( $_POST[ $key ] ) ){
					foreach( $_POST[ $key ] as $pk => $pv )
						$_POST[ $key ][ $pk ] =sanitize_text_field( $pv );
				} else {
		...
		<?php	
			if( $element['type'] == 'hierarchical-taxonomies' ):
					...
					?>
						<select data-pre="" data-emptyoption="<?php echo $element['select_label']; ?>" id="sf-field-<?php echo $key; ?>" data-taxonomy="<?php echo $data_value; ?>" data-taxkey="<?php echo $tkey; ?>" name="<?php echo $key; ?>" <?php if( $tkey != 0 ): echo 'style="display:none;"'; endif; ?>>
			...
			<select id="sf-field-<?php echo $key; ?>" name="<?php echo $key; ?>"><option value=""><?php if( isset( $element['all_options'] ) ) echo $element['all_options']; ?></option><?php
				if( $data_type == 'tax' && $element['options'] == 'auto' ):
					...
					?><option <?php if( isset( $_POST['data'][ $key ] ) && $_POST['data'][ $key ] == $term->term_id ) echo 'selected="selected"'; ?> value="<?php echo $term->term_id; ?>"><?php echo $term->name; ?></option><?php
					endforeach;
				...
				elseif( $data_type == 'meta' && $element['options'] == 'auto' ):
					...
					?>
					<option <?php if( isset( $_POST['data'][ $key ] ) && $_POST['data'][ $key ] == $val->meta_value ) echo 'selected="selected"'; ?> value="<?php echo $val->meta_value; ?>"><?php echo $val->meta_value; ?></option>					
					<?php
					endforeach;
				elseif( $element['options'] == 'individual' ):
					foreach( $element['option_key'] as $option_key => $val ):
					?>
					<option <?php if( isset( $_POST['data'][ $key ] ) && $_POST['data'][ $key ] == $val ) echo 'selected="selected"'; ?> value="<?php echo $val; ?>"><?php echo $element['option_val'][$option_key]; ?></option>
					<?php
					endforeach;
				elseif( $data_type == 'others' ):
					if( $data_value == 'author' ):
						...
						?>
						<option <?php if( isset( $_POST['data'][ $key ] ) && $_POST['data'][ $key ] == $author->ID ) echo 'selected="selected"'; ?> value="<?php echo $author->ID; ?>"><?php echo $author->data->display_name; ?></option>
						<?php
						endforeach;
					endif;
					if( $data_value == 'pub_d' ):
						...
						foreach( $days as $d ):
						?>
						<option <?php if( isset( $_POST['data'][ $key ] ) && $_POST['data'][ $key ] == $d->date ) echo 'selected="selected"'; ?> value="<?php echo $d->date; ?>"><?php echo $d->date; ?></option>
						<?php
						endforeach;
					endif;
					if( $data_value == 'pub_m' ):
						...
						foreach( $months as $m ):
						?>
						<option <?php if( isset( $_POST['data'][ $key ] ) && $_POST['data'][ $key ] == $m->date ) echo 'selected="selected"'; ?> value="<?php echo $m->date; ?>"><?php echo $m->date; ?></option>
						<?php
						endforeach;
					endif;
					if( $data_value == 'pub_y' ):
						...
						foreach( $years as $y ):
						?>
						<option <?php if( isset( $_POST['data'][ $key ] ) && $_POST['data'][ $key ] == $y->date ) echo 'selected="selected"'; ?> value="<?php echo $y->date; ?>"><?php echo $y->date; ?></option>
						<?php
						endforeach;
					endif;
			...
			elseif( $element['type'] == 'input' ):
				?>
				<input <?php if( isset( $_POST['data'][ $key ] ) ) echo 'value="' . $_POST['data'][ $key ] . '"'; ?> placeholder="<?php if( isset( $element['placeholder'] ) ) echo $element['placeholder']; else echo $element['fieldname']; ?>" id="sf-field-<?php echo $key; ?>" name="<?php echo $key; ?>" />
				<?php	
			...
			?>
				...
				<?php 
					if( $element['options'] == 'individual' ): ?>
						...
						?>
						<label><input type="checkbox" <?php if( isset( $_POST['data'][ $key ] ) && in_array( $val, $_POST['data'][ $key ] ) ) echo 'checked="checked"'; ?> value="<?php echo $val; ?>" name="<?php echo $key; ?>[]" /> <?php echo $element['option_val'][$option_key]; ?></label>
						<?php
						endforeach;
					...
					elseif( $data_type == 'tax' && $element['options'] == 'auto' ):
						...
						foreach( $terms as $term ): 
							?>
							<label><input type="checkbox" <?php if( isset( $_POST['data'][ $key ] ) && in_array( $term->term_id, $_POST['data'][ $key ] ) ) echo 'checked="checked"'; ?> value="<?php echo $term->term_id; ?>" name="<?php echo $key; ?>[]" /> <?php echo $term->name; ?></label>
							<?php 
						endforeach;
					elseif( $data_type == 'meta' && $element['options'] == 'auto' ):
						$values = get_postmeta_values( $data_value );
						foreach( $values as $val ):
						?>
						<label><input type="checkbox" <?php if( isset( $_POST['data'][ $key ] ) && in_array( $val->meta_value, $_POST['data'][ $key ] ) ) echo 'checked="checked"'; ?> value="<?php echo $val->meta_value; ?>" name="<?php echo $key; ?>[]" /> <?php echo $val->meta_value; ?></label>
						<?php
						endforeach;
					elseif( $data_type == 'others' ):
						if( $data_value == 'author' ):
							...
							foreach( $authors as $author ):
							?>
							<label><input type="checkbox" <?php if( isset( $_POST['data'][ $key ] ) && in_array( $author->ID, $_POST['data'][ $key ] ) ) echo 'checked="checked"'; ?> value="<?php echo $author->ID; ?>" name="<?php echo $key; ?>[]" /> <?php echo $author->data->display_name ?></label>
							<?php
							endforeach;
						endif;
					endif; ?>
			...
			?>
				<div class="sf-fulltext-wrapper">
					<input <?php if( isset( $_POST['data'][ $key ] ) ) echo 'value="' . $_POST['data'][ $key ] . '"'; ?> placeholder="<?php if( isset( $element['placeholder'] ) ) echo $element['placeholder']; else echo $element['fieldname']; ?>" name="<?php echo $key; ?>" />
				</div>
			<?php
			elseif( $element['type'] == 'orderby' ): ?>
				...
				$index = explode( '|', $e );
				$index = substr( $index[ count( $index ) - 1 ], 0, -1 );
				
				?>
					<option <?php if( isset( $_POST['data'][ $key ] ) && $e == $_POST['data'][ $key ] ) echo 'checked="checked"'; ?> value="<?php echo $e; ?>"><?php echo $element['orderbylabel'][ $index ]; ?></option>
				<?php endforeach; ?>				
				</select>
			<?php
			...
			?>
				...
				<?php 
					if( $element['options'] == 'individual' ): ?>
						<?php foreach( $element['option_key'] as $option_key => $val ):
						?>
						<label><input <?php if( isset( $_POST['data'][ $key ] ) && $val == $_POST['data'][ $key ] ) echo 'checked="checked"'; ?> type="radio" value="<?php echo $val; ?>" name="<?php echo $key; ?>" /> <?php echo $element['option_val'][$option_key]; ?></label>
						<?php
						endforeach;
					...
					elseif( $data_type == 'tax' && $element['options'] == 'auto' ):
						...
						foreach( $terms as $term ): 
							?>
							<label><input <?php if( isset( $_POST['data'][ $key ] ) && $term->term_id == $_POST['data'][ $key ] ) echo 'checked="checked"'; ?> type="radio" value="<?php echo $term->term_id; ?>" name="<?php echo $key; ?>" /> <?php echo $term->name; ?></label>
							<?php 
						endforeach;
					elseif( $data_type == 'meta' && $element['options'] == 'auto' ):
						$values = get_postmeta_values( $data_value );
						foreach( $values as $val ):
						?>
						<label><input type="radio" <?php if( isset( $_POST['data'][ $key ] ) && $val->meta_value == $_POST['data'][ $key ] ) echo 'checked="checked"'; ?> value="<?php echo esc_attr( $val->meta_value ); ?>" name="<?php echo $key; ?>" /> <?php echo $val->meta_value; ?></label>					
						<?php
						endforeach;
					...
					elseif( $data_type == 'others' ):
						if( $data_value == 'author' ):
							...
							foreach( $authors as $author ):
							?>
							<label><input <?php if( isset( $_POST['data'][ $key ] ) && $author->ID == $_POST['data'][ $key ] ) echo 'checked="checked"'; ?> type="radio" value="<?php echo $author->ID; ?>" name="<?php echo $key; ?>[]" /> <?php echo $author->data->display_name ?></label>
							<?php
							endforeach;
						endif;
					endif; ?>
			...
			?>
			<div class="sf-range-wrapper" <?php if( isset( $_POST['data'][ $key . '|min' ] ) ) echo 'data-posmin="' . $_POST['data'][ $key . '|min' ] . '" data-posmax="' . $_POST['data'][ $key . '|max' ] . '" '; ?> data-title="<?php echo esc_attr( $element['fieldname'] ); ?>" data-source="<?php echo $key; ?>" data-step="<?php if( isset( $element['step'] ) ) echo $element['step']; else echo '1'; ?>" data-start="<?php echo $element['start_range']; ?>" data-unitfront="<?php if( isset( $element['unit_front'] ) && $element['unit_front'] == 1 ) echo '1'; else echo '0'; ?>" data-end="<?php echo $element['end_range']; ?>" data-unit="<?php echo $element['unit']; ?>"></div>
			<?php
			endif;
		?>
		</fieldset>
	...
	<?php do_action( 'sf-after-form', $field ); ?>
			<?php
			if( isset( $preselect ) && is_array( $preselect ) ):
				$results = sf_do_search();
			elseif( isset( $attr['showall'] ) ):
				unset( $_POST['data'] );
	...
	<?php do_action( 'sf-after-result-head', $field ); ?>
	<?php endif; ?>
	<ul class="sf-result">
		<?php
			if( isset( $results ) ):				
	...
	<?php do_action( 'sf-after-results', $field ); ?>
	<ul class="sf-nav">
		<?php
			if( isset( $results ) ):				
	...
	<?php do_action( 'sf-after-navigation', $field ); ?>
</div>
...
Query:
<?php print_r( $results['query'] ); ?>
<?php if( isset( $preselect ) ): ?>
Preset:
<?php echo $preset; ?>
<?php print_r( $preselect ); ?>
<?php endif; ?>
</pre>
	<?php endif; ?>