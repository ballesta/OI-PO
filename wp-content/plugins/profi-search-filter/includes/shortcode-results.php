...
if( !isset( $_POST['search-id'] ) && ( isset( $attr['showall'] ) && isset( $attr['id'] ) ) ):
	$_POST['search-id'] = $attr['id'];
endif;
...
<div class="sf-wrapper">
	...
	<?php do_action( 'sf-after-result-head', '' ); ?>
	<?php endif; ?>
	
	<ul class="sf-result">
		<?php foreach( $data['result'] as $r ) echo $r; ?>
	</ul>	
	<?php do_action( 'sf-after-results', '' ); ?>
	<ul class="sf-nav">
		<?php foreach( $data['nav'] as $r ) echo $r; ?>
	</ul>	
	<?php do_action( 'sf-after-navigation', '' ); ?>
</div>
