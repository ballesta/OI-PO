...
<div id="wrap" class="sf-wrap">
				...
				<table>
					...
					foreach( $field['meta'] as $meta ): ?>
						<tr>
							...
							<td><input class="sf-array" type="checkbox" checked="checked" name="orderby[<?php echo $i; ?>]" value="meta[<?php echo $meta; ?>|asc]"></td>
						...
						<tr>
							...
							<td><input class="sf-array" type="checkbox" checked="checked" name="orderby[<?php echo $i; ?>]" value="meta[<?php echo $meta; ?>|desc]"></td>
					...
					<?php $i++; endforeach; endif;?>
						<tr>
							...
							<td><input class="sf-array" type="checkbox" checked="checked" name="orderby[<?php echo $i; ?>]" value="post[date|asc]"></td>
						...
						<tr>
							...
							<td><input class="sf-array" type="checkbox" checked="checked" name="orderby[<?php echo $i; ?>]" value="post[date|desc]"></td>
	...
	<form method="post" class="sf-form">
		...
		<?php wp_nonce_field( 'save-new-sf', 'sf-wpnonce', false, true ); ?>
