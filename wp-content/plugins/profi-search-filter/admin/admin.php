<?php
	...
	function sf_adminscripts( $hook ){
		...
		wp_localize_script( 'sf-admin-js', 'objectL10n', array(
			...
			'pub_d'	=>	__('Publication day', 'sf' ),
			'pub_m'	=>	__('Publication month', 'sf' ),
			'pub_y'	=>	__('Publication year', 'sf' ),
			'mod_d'	=>	__('Modification day', 'sf' ),
			'mod_m'	=>	__('Modification month', 'sf' ),
			'mod_y'	=>	__('Modification year', 'sf' ),
			'hierarchical_taxonomies'	=>	__('Hierarchical Taxonomies', 'sf' ),
			'all_options'	=>	__('Text for all options', 'sf' ),
			'label'	=>	__('Label', 'sf' ),
			'choose'	=>	__('Choose', 'sf' ),
			'label_to_display_in_selectbox'	=>	__('Which text will be shown in the selectboxes? <code>%name%</code> is the placeholder for the taxonomy name', 'sf' )
		) );
