	...
	*/
	...
	if( isset( $_POST['sf'] ) ):
		...
		if( isset( $_POST['sf_step'] ) && $_POST['sf_step'] == 2 ):
			$field['tax'] = $sf['tax'];
			$field['meta'] = $sf['meta'];
			$field['order-standard'] = $sf['order-standard'];
			$field['orderby-type'] = $sf['orderby-type'];
		endif;
				...
				<fieldset>
					...
					<section>
						...
						<select id="sf_highlight" name="sf[highlight]">
							<option <?php if( 1 == $field['highlight'] ) echo 'selected="selected"'; ?> value="1"><?php _e( 'Yes', 'sf' ); ?></option>
							<option <?php if( 0 == $field['highlight'] ) echo 'selected="selected"'; ?> value="0"><?php _e( 'No', 'sf' ); ?></option>
						</select>
					...
					<section>
						...
						<select id="sf_head" name="sf[head]">
							<option <?php if( !isset( $field['head'] ) || 1 == $field['head'] ) echo 'selected="selected"'; ?> value="1"><?php _e( 'Yes', 'sf' ); ?></option>
							<option <?php if( isset( $field['head'] ) && 0 == $field['head'] ) echo 'selected="selected"'; ?> value="0"><?php _e( 'No', 'sf' ); ?></option>
						</select>
					...
					<section>
						...
						<input value="<?php if( isset( $field['posts_per_page'] ) ) echo $field['posts_per_page']; else echo 'auto'; ?>" id="sf_posts_per_page" name="sf[posts_per_page]" />
					</section>
					<section>
			...
			<form method="post" class="sf-form"><?php wp_nonce_field( 'update-sf', 'sf-wpnonce', false ); ?>
				...
				<div class="welcome-panel">
					...
					<select name="sf[order-standard]">
						<option></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|date|asc' ) echo 'selected="selected" '; ?> value="post|date|asc"><?php _e( 'Date ascending', 'sf' ); ?></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|date|desc' ) echo 'selected="selected" '; ?> value="post|date|desc"><?php _e( 'Date descending', 'sf' ); ?></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|title|asc' ) echo 'selected="selected" '; ?> value="post|title|asc"><?php _e( 'Title ascending', 'sf' ); ?></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|title|desc' ) echo 'selected="selected" '; ?> value="post|title|desc"><?php _e( 'Title descending', 'sf' ); ?></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|ID|asc' ) echo 'selected="selected" '; ?> value="post|ID|asc"><?php _e( 'ID ascending', 'sf' ); ?></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|ID|desc' ) echo 'selected="selected" '; ?> value="post|ID|desc"><?php _e( 'ID descending', 'sf' ); ?></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|name|asc' ) echo 'selected="selected" '; ?> value="post|name|asc"><?php _e( 'URL name ascending', 'sf' ); ?></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|name|desc' ) echo 'selected="selected" '; ?> value="post|name|desc"><?php _e( 'URL name descending', 'sf' ); ?></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|modified|asc' ) echo 'selected="selected" '; ?> value="post|modified|asc"><?php _e( 'Modified date ascending', 'sf' ); ?></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|modified|desc' ) echo 'selected="selected" '; ?> value="post|modified|desc"><?php _e( 'Modified date descending', 'sf' ); ?></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|comment_count|asc' ) echo 'selected="selected" '; ?> value="post|comment_count|asc"><?php _e( 'Number of comments ascending', 'sf' ); ?></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|comment_count|desc' ) echo 'selected="selected" '; ?> value="post|comment_count|desc"><?php _e( 'Number of comments descending', 'sf' ); ?></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|menu_order|asc' ) echo 'selected="selected" '; ?> value="post|menu_order|asc"><?php _e( 'Menu order ascending', 'sf' ); ?></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|menu_order|desc' ) echo 'selected="selected" '; ?> value="post|menu_order|desc"><?php _e( 'Menu order descending', 'sf' ); ?></option>
						<?php foreach( $metas as $key => $val ): ?>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'meta|' . $key . '|asc' ) echo 'selected="selected" '; ?> value="meta|<?php echo $key; ?>|asc"><?php echo ucfirst( $key ); ?> <?php _e( 'ascending', 'sf' ); ?></option>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'meta|' . $key . '|desc' ) echo 'selected="selected" '; ?> value="meta|<?php echo $key; ?>|desc"><?php echo ucfirst( $key ); ?> <?php _e( 'descending', 'sf' ); ?></option>
						<?php endforeach; ?>
						<option <?php if( isset( $field['order-standard'] ) &&  $field['order-standard'] == 'post|rand|' ) echo 'selected="selected" '; ?> value="post|rand|"><?php _e( 'Random', 'sf' ); ?>*</option>
					</select>
					<p>For more information please visit <a href="http://www.profisearchform.com/standard-orderby-information/" target="_blank">Standard orderby information</a><br />
					<small>*) <?php _e( 'Not recommended', 'sf' ); ?></small></p>
					<p><label for="orderby-type"><?php _e( 'Order mode', 'sf' ); ?>:</label></p>
					<select name="sf[orderby-type]" id="orderby-type">
						<option <?php if( isset( $field['orderby-type'] ) && $field['orderby-type'] == 'abc' ) echo 'selected="selected"'; ?> value="abc"><?php _e( 'alphabetical order', 'sf' ); ?></option>
						<option <?php if( isset( $field['orderby-type'] ) && $field['orderby-type'] == '123' ) echo 'selected="selected"'; ?> value="123"><?php _e( 'numerical order', 'sf' ); ?></option>
					</select>
				</div>
				<hr />
				<input class="button" type="submit" value="<?php _e( 'Update', 'sf' ); ?>" />
		...
		<div id="layout">
			...
			<div class="sf-accordion">
				...
				<div>
					...
					<?php if( $field['highlight'] == 1 ): ?><label for="sfhighlightcolor"><?php _e( 'Highlight Color' ); ?>: </label><input id="sfhighlightcolor" type="text" value="<?php echo $field['highlightcolor']; ?>" name="sf[highlightcolor]" class="sf-colorfield" /><?php endif; ?>
				</div>
		...
		<div style="display:none;">
			<select id="sf-datasource">
				<optgroup label="<?php _e( 'Taxonomies', 'sf' ); ?>">
					<?php foreach( $field['tax'] as $meta ): 
						$taxInfo = get_taxonomies( array( 'name' => $meta ), 'objects' );
					?>
					<option <?php if( $taxInfo[ $meta ]->hierarchical == 1 ) echo 'data-hierarchy="1" '; ?>value="tax[<?php echo $meta; ?>]"><?php echo $meta; ?></option>
					<?php endforeach; ?>
			...
			<div id="sf-orderbysource">
				<table>
					<thead>
						<tr>
							<th><?php _e( 'Field', 'sf' ); ?></th><th></th><th><?php _e( 'Label', 'sf' ); ?></th><th><?php _e( 'ABC/123', 'sf' ); ?></th></tr>
						</tr>
					</thead>
					<tbody>
					<?php 
					...
					foreach( $field['meta'] as $meta ): ?>
						<tr>
							<td><?php echo $meta; ?> <?php _e( 'ascending', 'sf' ); ?></td>
							<td><input class="sf-array" type="checkbox" checked="checked" name="orderby[<?php echo $i; ?>]" value="meta[<?php echo $meta; ?>|asc|<?php echo $i; ?>]"></td>
							<td><input class="sf-orderbylabel sf-array" name="orderbylabel[<?php echo $i; ?>]" value="<?php echo $meta; ?> <?php _e( 'ascending', 'sf' ); ?>" /></td>
							<td>
								<select class="sf-array" name="orderbynumerical[<?php echo $i; ?>]">
									<option value="abc"><?php _e( 'Alphabetical order', 'sf' ); ?></option>
									<option value="123"><?php _e( 'Numerical order', 'sf' ); ?></option>
								</select>
							</td>
						</tr>
						<?php $i++; ?>
						<tr>
							<td><?php echo $meta; ?> <?php _e( 'descending', 'sf' ); ?></td>
							<td><input class="sf-array" type="checkbox" checked="checked" name="orderby[<?php echo $i; ?>]" value="meta[<?php echo $meta; ?>|desc|<?php echo $i; ?>]"></td>
							<td><input class="sf-orderbylabel sf-array" name="orderbylabel[<?php echo $i; ?>]" value="<?php echo $meta; ?> <?php _e( 'descending', 'sf' ); ?>" /></td>
							<td>
								<select class="sf-array" name="orderbynumerical[<?php echo $i; ?>]">
									<option value="abc"><?php _e( 'Alphabetical order', 'sf' ); ?></option>
									<option value="123"><?php _e( 'Numerical order', 'sf' ); ?></option>
					...
					<?php $i++; endforeach; endif;?>
						<tr>
							<td><?php _e( 'Date ascending', 'sf' ); ?></td>
							<td><input class="sf-array" type="checkbox" checked="checked" name="orderby[<?php echo $i; ?>]" value="post[date|asc|<?php echo $i; ?>]"></td>
							<td><input class="sf-orderbylabel sf-array" name="orderbylabel[<?php echo $i; ?>]" value="<?php _e( 'Date ascending', 'sf' );  ?>" /></td>
							<td></td>
						</tr>
					<?php $i++; ?>
						<tr>
							<td><?php _e( 'Date descending', 'sf' ); ?></td>
							<td><input class="sf-array" type="checkbox" checked="checked" name="orderby[<?php echo $i; ?>]" value="post[date|desc|<?php echo $i; ?>]"></td>
							<td><input class="sf-orderbylabel sf-array" name="orderbylabel[<?php echo $i; ?>]" value="<?php _e( 'Date descending', 'sf' ); ?>" /></td>
							<td></td>
						</tr>
					</tbody>
				</table>
		...
		<form method="post" class="sf-form"><?php wp_nonce_field( 'update-sf', 'sf-wpnonce', false ); ?>
			...
			<div class="field filter">
				...
				$img_array = array(
								...
								'date'		=>	'date.png',
								'hierarchical-taxonomies'	=>	'hierarchical-taxonomies.png'
				);
				$i = 0;
...
<span><?php echo $f['fieldname']; ?></span>
	...
	<?php endforeach; ?>
			...
			<div class="field elements">
				...
				<div data-attr='{"type":"hierarchical-taxonomies"}'>
					<img src="<?php echo SF_URL ?>res/admin/hierarchical-taxonomies.png" alt="<?php __( 'Hierarchical Taxonomies', 'sf' ); ?>" />
					<span><?php _e( 'Hierarchical Taxonomies', 'sf' ); ?></span>
				</div>
