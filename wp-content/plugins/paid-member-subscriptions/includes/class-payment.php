...
Class PMS_Payment {
    ...
    public function add( $user_id, $status, $date, $amount, $subscription_plan_id ) {
        ...
        $insert_result = $wpdb->insert( $wpdb->prefix . 'pms_payments', array( 'user_id' => $user_id, 'status' => $status, 'date' => $date, 'amount' => $amount, 'subscription_plan_id' => $subscription_plan_id ) );
