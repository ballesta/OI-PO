...
Class PMS_Member {
    ...
    public function get_subscriptions() {
        ...
        $subscriptions = $wpdb->get_results( "SELECT subscription_plan_id, start_date, expiration_date, status FROM {$wpdb->prefix}pms_member_subscriptions WHERE user_id = $this->user_id", ARRAY_A );
