                ...
                if( !$member ) {
                    ...
                    foreach( $subscription_plans as $subscription_plan ) {
                        ...
                        $subscription_plan_output = '<div class="pms-subscription-plan">';
                            ...
                            $subscription_plan_output .= '<input type="radio" name="subscription_plans" value="' . esc_attr($subscription_plan->id) . '" ' .  ( isset( $_REQUEST['subscription_plans'] ) ? checked( $_REQUEST['subscription_plans'], $subscription_plan->id, false ) : ( $default_checked == $subscription_plan->id ? 'checked="checked"' : '' ) ) . ' />';
