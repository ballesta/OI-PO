...
Tags: bbpress,global options,options,settings,toolkit,manage options,close forum,protect forum,hack,tweak
...
* Remove or change informational messages and descriptions
* Remove or adapt Breadcrumb (change text, separator, add text before)
...
Special thanks to Robkk for his input!
...
== Upgrade Notice ==
= 1.0.6 =
New options and fixes, ready for translation. Check out the ChangeLog !

= 1.0.4 =
Make sure to click SAVE SETTINGS immediately after upgrade (to regenerate your CSS file).

= 1.0.0 =
bbP Manage Subscriptions will no longer manage Global Settings
...
* Shorten Fresness wording for topics and replies
