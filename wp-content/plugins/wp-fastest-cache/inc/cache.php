	...
	class WpFastestCacheCreateCache extends WpFastestCache{
		...
		public function createCache(){
			if(isset($this->options->wpFastestCacheStatus)){
				...
				if($this->options->wpFastestCacheLoggedInUser && $this->options->wpFastestCacheLoggedInUser == "on"){
				...
				if(preg_match("/^https/i", get_option("home")) && !preg_match("/^https/i", home_url())){
