<?php
	class WpFastestCacheAdmin extends WpFastestCache{
		...
		public function save_pre_load(){
			if(!get_option("WpFastestCachePreLoad")){
				$data = array("homepage" => false, "single" => false, "tags" => false, "categories" => false);
			...
			// $file = $this->getWpContentDir()."/cache/wpfc-preload.json";
		...
		public function optionsPage(){
			...
			<div class="wrap">
				...
				<div class="tabGroup">
				    ...
				    <div class="tab1" style="padding-left:10px;">
						<form method="post" name="wp_manager">
							...
							<div class="questionCon" style="display:none;">
								<div class="question">Pre-load</div>
				    ...
				    <div class="tab3">
				    	<h2 style="padding-bottom:10px;padding-left:20px;">Timeout Rules</h2>
