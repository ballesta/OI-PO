...
class TLPteam
{
	...
	function __construct(){
        $this->options = array('settings' => 'tpl_portfolio_settings');
        ...
        $this->assetsUrl        = TPL_TEAM_PLUGIN_URL  . '/assets/';
...
register_activation_hook(TPL_TEAM_PLUGIN_PATH, array('TLPteamPostTypeRegistrations', 'activate'));
register_deactivation_hook(TPL_TEAM_PLUGIN_PATH, array('TLPteamPostTypeRegistrations', 'deactivate'));
