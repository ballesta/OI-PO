...
if (!class_exists('TLPteamPostMeta')):
    ...
    class TLPteamPostMeta
    {
        ...
        function tlp_team_meta($post){
            ...
            <div class="member-field-holder">
                ...
                <div class="tlp-field-holder">
                    <div class="tplp-label">
                        <label for="short_bio"><?php _e('Short Bio:', TPL_TEAM_SLUG); ?></label>
                    </div>
                    <div class="tlp-field">
                        <textarea name="short_bio" rows="5" class="tlpfield" value=""><?php echo (@$meta['short_bio'][0] ? @$meta['short_bio'][0] : null) ?></textarea>
                        <span class="desc"><?php _e('Add some short bio', TPL_TEAM_SLUG); ?></span>
                    </div>
                </div>

                <div class="tlp-field-holder">
                    <div class="tplp-label">
                        <label for="designation"><?php _e('Designations', TPL_TEAM_SLUG); ?>:</label>
                    </div>
                    <div class="tlp-field">
                ...
                <div class="tlp-field-holder">
                    <div class="tplp-label">
                        <label for="email"><?php _e('Email', TPL_TEAM_SLUG); ?>:</label>
                    </div>
                    <div class="tlp-field">
                ...
                <div class="tlp-field-holder">
                    <div class="tplp-label">
                        <label for="web_url"><?php _e('Personal Web URL', TPL_TEAM_SLUG); ?>:</label>
                    </div>
                    <div class="tlp-field">
                ...
                <div class="tlp-field-holder">
                    <div class="tplp-label">
                        <label for="url"><?php _e('Telephone', TPL_TEAM_SLUG); ?>:</label>
                    </div>
                    <div class="tlp-field">
                ...
                <div class="tlp-field-holder">
                    <div class="tplp-label">
                        <label for="location"><?php _e('Location', TPL_TEAM_SLUG); ?>:</label>
                    </div>
                    <div class="tlp-field">
            ...
            <h2 class="hndle ui-sortable-handle"><?php _e('Social Links', TPL_TEAM_SLUG); ?></h2>
            <?php
