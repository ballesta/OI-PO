	...
	*/
	class TLPteamPostTypeAdmin
	{
		...
		public function arrange_team_columns( $columns ) {
			$column_thumbnail = array( 'thumbnail' => __( 'Image', TPL_TEAM_SLUG ) );
			$column_designation = array( 'designation' => __( 'Designation', TPL_TEAM_SLUG ) );
			$column_email = array( 'email' => __( 'Email', TPL_TEAM_SLUG ) );
			$column_location = array( 'location' => __( 'Location', TPL_TEAM_SLUG ) );
