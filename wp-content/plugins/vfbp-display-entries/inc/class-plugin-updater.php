...
if ( class_exists( 'VFB_Pro_Plugin_Updater' ) ) {
	class VFB_Pro_Addon_Display_Entries_Plugin_Updater extends VFB_Pro_Plugin_Updater {
		...
		public function __construct() {
			$this->name    = plugin_basename( VFB_DISPLAY_ENTRIES_PLUGIN_FILE );
			$this->slug    = basename( VFB_DISPLAY_ENTRIES_PLUGIN_FILE, '.php');
			$this->version = VFB_DISPLAY_ENTRIES_PLUGIN_VERSION;
