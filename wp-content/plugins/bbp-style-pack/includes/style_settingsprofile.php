...
function bsp_profile_settings() {
 ?>
					...
					<tr valign="top">
						...
						<h3>
						<?php _e ('Profile Settings' , 'bbp-style-pack' ) ; ?>
						</h3>
...
<p>
<?php _e ('Only one setting at the moment!' , 'bbp-style-pack' ) ; ?>
</p>
<p/>
<p>
...
<!--add gravatar to menu ---------------------------------------------------------------------->			
			<tr>
	<th colspan="2">
	<?php _e ("Show a gravatar link on the profile page" , 'bbp-style-pack' ) ; ?></th>
	<td colspan="2">
	<?php
...
<!--Gravatar page ---------------------------------------------------------------------->
			...
			?>
			<td></td>
			<td> <?php echo '1. '.$name1 ; ?> </td>
			<td>
			<?php echo '<input id="'.$item1.'" class="large-text" name="'.$item1.'" type="text" value="'.$value1.'"<br>' ; ?> 
			<label class="description"><?php _e( 'Enter the label name', 'bbp-style-pack' ); ?></label><br/></td>
			</tr>
			<tr>
			<td></td>
			<td> <?php echo '2. '.$name2 ; ?> </td>
			<td>
			<?php echo '<input id="'.$item2.'" class="large-text" name="'.$item2.'" type="text" value="'.$value2.'"<br>' ; ?> 
			<label class="description"><?php _e( 'Enter any text eg "Manage your profile picture at"', 'bbp-style-pack' ); ?></label><br/>
			</td>
			</tr>
			<tr>
			<td></td>
			<td> <?php echo '3. '.$name3 ; ?> </td>
			<td>
			<?php echo '<input id="'.$item3.'" class="large-text" name="'.$item3.'" type="text" value="'.esc_html ($value3).'"<br>' ; ?> 
			<label class="description"><?php _e( 'You should create either a wordpress page with gravatar instructions or link to gravatar eg http://www.mysite.com/gravatar-explanation-page or https://en.gravatar.com/', 'bbp-style-pack' ); ?></label><br/>
			</td>
			</tr><tr>
			<td></td>
			<td> <?php echo '4. '.$name4 ; ?> </td>
			<td>
			<?php echo '<input id="'.$item4.'" class="large-text" name="'.$item4.'" type="text" value="'.$value4.'"<br>' ; ?> 
			<label class="description"><?php _e( 'Enter text you want this link to show eg "click here" or "https://en.gravatar.com/"', 'bbp-style-pack' ); ?></label><br/>
			</td>
			</tr>
...
<br>
<strong><?php _e ("What is an Avatar?", 'bbp-style-pack' ) ; ?>
</strong>
<br>
